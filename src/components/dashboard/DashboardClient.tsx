...
type Currency = 'GBP' | 'EUR' | 'USD' | 'AUD' | 'CAD' | 'NZD';
...
const currencySym = (c: Currency) => (c === 'GBP' ? 'GBP ' : c === 'EUR' ? 'EUR ' : c === 'USD' ? 'USD ' : c === 'AUD' ? 'AUD ' : c === 'CAD' ? 'CAD ' : 'NZD ');
...
function money(n: number, c: Currency) {
  ...
  const sym = c === 'GBP' ? '£' : c === 'EUR' ? '€' : c === 'USD' ? '$' : c === 'AUD' ? 'A$' : c === 'CAD' ? 'C$' : 'NZ$';
